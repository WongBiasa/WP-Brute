...
if len(sys.argv) <= 1:
    print 'WP-crack v1.0 (c)2019 Recoded  by AditArlos - a very fast logon WordPress Cracker'
    print 'recoder by: WhoMHw'
    print 'Mail   : mbiasa736@gmail.com'
    print ''
    print 'WP-crack v1.0'
    print ''
    print ' __      ____________          __________                __ '         
    print'/  \    /  \______   \         \______   \_______ __ ___/  |_  ____  '
    print'\   \/\/   /|     ___/  ______  |    |  _/\_  __ \  |  \   __\/ __ \ '
    print ' \        / |    |     /_____/  |    |   \ |  | \/  |  /|  | \  ___/ '
    print '  \__/\  /  |____|              |______  / |__|  |____/ |__|  \___  >'
    print '       \/                              \/                         \/    V1.0'
    ...
    print ''
    print 'Examples: python Wp-Brute.py -h http://test.com/wp-login.php -u admin -P password.txt'
    sys.exit()
 
print 'WP-crack 1.0 (c)2019 by Adit Arlos - a very fast logon WordPress Cracker'
print 'recoder: WHoMHw'
print 'Mail   : mbiasa736@gmail.com'
...
try:
    ...
    print "\n\t[!] Mohon periksa koneksi kamu tod:v"
